...
@section('content')
    ...
    <div class="page-header">
        <div>
            ...
            <p class="section-subtitle">Update administrator information and profile picture</p>
        </div>
        <a href="{{ route('admins.show', $admin) }}" class="btn btn-secondary">← Back to Profile</a>
    </div>
    ...
    <div class="card" style="max-width: 780px; margin: 0 auto;">
        <form action="{{ route('admins.update', $admin) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 1.5rem;">
                <h3 style="margin-bottom: 1rem;">Administrator Information</h3>
            </div>
            ...
            <div class="field-group">
                ...
                <input
                    type="text"
                    value="{{ $admin->created_at->format('M d, Y') }}"
                    class="field-input"
                    disabled>
            </div>
