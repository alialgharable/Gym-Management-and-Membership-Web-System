...
@section('content')
        ...
        <div class="card-grid">
            @foreach ($trainers as $trainer)
                <div class="card">
                    ...
                    <p style="font-size: 0.9rem; color: #a9a89d;">Classes: {{ $trainer->gymClasses->count() }} | Reviews:
                        {{ $trainer->reviews->count() }}</p>
    ...
    @else
        <div class="alert alert-warning">
            No trainers found. <a href="{{ route('trainers.create') }}" style="color: #ffd700; font-weight: bold;">Add one
                now</a>
        </div>
    @endif
@endsection